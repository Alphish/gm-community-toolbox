...
/// @arg {Array<String>} aliases                                Aliases for the same functionality.
...
function ReferenceFunctionStub(_keyname, _aliases, _summary, _arguments, _returns, _sections, _updates) : ReferenceItemStub("func", _keyname, _keyname, _summary, _sections) constructor {
    aliases = _aliases;
